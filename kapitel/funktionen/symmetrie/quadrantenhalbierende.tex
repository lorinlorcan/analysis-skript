...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\draw[color1, smooth, samples=100, domain=-10:-1-1/10] plot (\x, {(5*\x)/(\x + 1)-2});
			\draw[color1, smooth, samples=100, domain=-1+1/10:10] plot (\x, {(5*\x)/(\x + 1)-2});
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\draw[color1, smooth, samples=100, domain=-10:1-1/10] plot (\x,
			{(\x + 1)/(\x - 1)});
			\draw[color1, smooth, samples=100, domain=1+1/10:10] plot (\x,
			{(\x + 1)/(\x - 1)});
