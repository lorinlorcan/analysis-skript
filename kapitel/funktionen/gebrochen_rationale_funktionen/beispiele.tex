...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\draw [color1, smooth, samples=100, domain=-4:-1/100] plot (\x, {1 / \x});
			\draw [color1, smooth, samples=100, domain=1/100:4] plot (\x, {1 / \x});
		\end{axis}
	\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\draw [color1, smooth, samples=100, domain=-4:-1/10] plot (\x, {1 /
					(pow(\x, 2))});
			\draw [color1, smooth, samples=100, domain=1/10:4] plot (\x, {1 /
					(pow(\x, 2))});
		\end{axis}
	\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\draw [color1, smooth, samples=100, domain=-4:9/10] plot (\x, {1 /
					(pow((\x - 1), 2))});
			\draw [color1, smooth, samples=100, domain=11/10:4] plot (\x, {1 /
					(pow((\x - 1), 2))});
