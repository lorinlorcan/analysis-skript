...
\begin{figure}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[mark=x] coordinates {(2, 2)};
			\addplot[mark=x] coordinates {(2, -2)};
...
\begin{figure}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\draw[dotted, thick] (0, 0) -- (2, 2);
			\draw[dotted, thick] (0, 2) -- (2, 2);
			\draw[dotted, thick] (2, 0) -- (2, 2);

			\node[above right] at (axis cs: 2, 2) {\( z=a+ib \)};
			\node[right] at (axis cs: 2, 1) {\( r \cdot \sin \varphi \)};
			\node[above] at (axis cs: 1, 2) {\( r \cdot \cos \varphi \)};
			\node[below right] at (axis cs: 2, -2) {\( z=a-ib \)};
			\node[below] at (axis cs: 0.6, 0.6) {\( \varphi \)};
			\node[above, rotate=45] at (axis cs: 1, 1) {\( |z|=r \)};
