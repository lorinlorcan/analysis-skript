...
\begin{figure}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[color1, thick, mark=x] coordinates {(2, 2)};
			\addplot[color1, thick, mark=x] coordinates {(2, -2)};
			...
			\draw[color1, dashed, thick] (0, 0) -- (2, 2);
			\draw[color1, dashed, thick] (0, 0) -- (2, -2);
...
\begin{figure}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\draw[color3, dashed, thick] (0, 2) -- (2, 2);
			\draw[color2, dashed, thick] (2, 0) -- (2, 2);

			\node[above right] at (axis cs: 2, 2) {\( z=a+ib \)};
			\node[color2, right] at (axis cs: 2, 1) {\( r \cdot \sin \varphi \)};
			\node[color3, above] at (axis cs: 1, 2) {\( r \cdot \cos \varphi \)};
			\node[below right] at (axis cs: 2, -2) {\( z=a-ib \)};
			\node[below] at (axis cs: 0.6, 0.6) {\( \varphi \)};
			\node[color1, above, rotate=45] at (axis cs: 1, 1) {\( |z|=r \)};
