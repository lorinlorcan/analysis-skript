...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[color2, smooth, samples=100, domain=-1:4.5] {2};
			\addplot[color2, dashed, smooth, samples=100, domain=-1:4.5] { (x-2) + 2};
			\addplot[color1, smooth, samples=100, domain=-1:4.5] { (x-2)^2 + (x-2) + 2};
			\addplot[color1, smooth, samples=100, domain=-1:4.5] {(x-2)^3 + (x-2)^2 + (x-2) + 2};
